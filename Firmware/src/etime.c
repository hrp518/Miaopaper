...
_attribute_ram_code_ void init_time(void)
{
    ...
    current_unix_time = 1783699200;  // 2026-07-11 00:00:00 UTC
    current_date.tm_year = 2026;
    current_date.tm_month = 7;
    current_date.tm_week = 6;  // Saturday
    current_date.tm_day = 11;
